...
Considering what has been just said, we define three main goals of this thesis as described in the following three subsections. 
...
\secc  To develop a data processing algorithm capable of visualizing non-point-like structures of lightning discharges
  ...
  Displaying lightning as single points on maps, as is common in many lightning detection networks, intuitively misrepresents a phenomenon that is inherently a spatially extended. This oversimplification hinders scientific analysis and public understanding. New algorithms are required to transform raw data (e.g., VLF signals) into visual representations that more accurately depict the three-dimensional, dynamic, and branching nature of lightning channels, thereby improving both scientific interpretation and practical applications like mapping.
...
While technical standards, such as IEC 62305, have been developed based on applied observations using mentioned instruments, their focus is on defining parameters for protecting technical devices against lightning currents. These standards simplify the modeling of lightning currents to address the needs of anthropogenic terrestrial objects, which are inherently influenced by artificial factors.
