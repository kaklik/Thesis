...
\abstractEN {This dissertation investigates lightning and related ionizing radiation phenomena using newly developed radio, optical, and ionizing radiation instruments. A set of devices was created, including a software-defined receiver for VLF and UHF bands designed for lightning detection and mapping, EMI-resistant ionizing radiation detectors, a synchronized triggering system, and the storm-resistant unmanned autogyro TF-G2 equipped with the TF-ATMON telemetry system.
By combining ground-based, airborne, and stratospheric measurements, the research enables simultaneous observation of optical, electromagnetic, and radiation manifestations of thunderstorm activity. The collected data show that lightning discharges often last longer and cover a larger area than traditional models and standards assume. The median duration of discharges derived from correlated optical and radio data exceeds half a second (524 ms), challenging the commonly used values for lightning event duration.
The study demonstrates that an integrated multi-domain approach improves the understanding of storm electrodynamics and establishes a basis for further research on the relationship between lightning and ionizing radiation. The developed instruments also represent a practical contribution to modern atmospheric measurements.}

\abstractCZ {Tato disertační práce se zabývá výzkumem blesků a souvisejících jevů ionizujícího záření pomocí nově vyvinutých rádiových, optických a radiačních přístrojů. Byla vytvořena sada zařízení zahrnující softwarově definovaný přijímač pro pásma VLF a UHF určený k detekci a mapování blesků, elektromagneticky odolné detektory ionizujícího záření, synchronizovaný systém pro spouštění záznamu a bouřkám odolný bezpilotní vírník TF-G2 s telemetrickým systémem TF-ATMON.
Kombinací pozemních, leteckých a stratosférických měření umožňuje výzkum současné pozorování optických, elektromagnetických a radiačních projevů bouřkové činnosti. Naměřená data ukazují, že bleskové výboje často trvají déle a zasahují větší oblast, než předpokládají tradiční modely a normy. Medián trvání výbojů odvozený z korelovaných optických a rádiových dat přesahuje půl sekundy (524 ms), což zpochybňuje dosud běžně používané hodnoty délky trvání bleskové události.
Práce dokládá, že integrovaný multidoménový přístup zlepšuje porozumění elektrodynamice bouří a vytváří základ pro další výzkum vztahu mezi blesky a ionizujícím zářením. Vyvinuté přístroje zároveň představují praktický přínos pro moderní atmosférická měření.}
...
\picw=14cm \cinspic ./img/FIK-6_RAW_data.png
...
\vfil\break
{\footline={} \headline={} \picw=\pdfpagewidth  % bez hlavičky a bez čísla stran, zařadit na plnou šířku
 \fornum 1..14 \do{ \picparams={page#1}
...
\vfil\break
{\footline={} \headline={} \picw=\pdfpagewidth  % bez hlavičky a bez čísla stran, zařadit na plnou šířku
 \fornum 1..8 \do{ \picparams={page#1}
...
\vfil\break
{\footline={} \headline={} \picw=\pdfpagewidth  % bez hlavičky a bez čísla stran, zařadit na plnou šířku
 \fornum 1..16 \do{ \picparams={page#1}
