The following chapter describes experiments made with the proposed instrumentation from chapter \ref[instrumentation] either for verify the instruments performance or directly obtain the results described in the chapter \ref[instrumentation].
