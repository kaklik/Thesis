...
\medskip
\label[R-P_maximum]
\picw=8cm \cinspic ./img/FIK-6_R-P_maximum.png
...
During the measuring campaigns, the method of data recording developed as well. The first campaigns were trying to make fully automatic recordings based on observed electromagnetic signals using the described LIGHTNING01 module. Please refer to the section \ref[LIGHTNING01A] for details.
