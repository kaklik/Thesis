...
\medskip
\label[E_mill_data]{Example of data measured by EFM mounted on autogyro}
...
\medskip
\label[RTK_moving_baseline]{RTK antennas mounted on a vehicle}
