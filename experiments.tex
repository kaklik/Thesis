...
\caption/f   Measuring CAR2 equipped with a roof platform used to carry and takeoff the TF-G2 autogyro at the thunderstorm site. The rotor fixing is the black arm on the left. The gray tubes are oriented vertically during takeoff and  weights insede are used to prerotate the rotor to minimum RPMs.  The embedded video file: {\em TF-G2_autogyro_takeoff.mp4} shows the takeoff process. (Clict on the Figure to play the video)  
\endinsert
