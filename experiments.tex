...
\caption/f   The embedded video file: {\em 2022-08-26-16-09-04.213386-lightning.mp4} shows lightning  negative leader with subsequent IC return stroke. Please click on the Figure to play the video, alternatively, the file could be extracted from the PDF or replayed on the web \hbox\url{https://youtube.com/shorts/pkGc1q3btuE}.
\endinsert
