...
\caption/f Measuring CAR2 equipped with a roof platform used to carry and take off the TF-G2 autogyro at the thunderstorm site. The rotor fixing is the black arm on the left. The gray tubes are oriented vertically during takeoff and weights inside are used to prerotate the rotor to minimum RPMs. The embedded video file: {\em TF-G2_autogyro_takeoff.mp4} shows the takeoff process. Please click on the Figure to play the video, alternatively, the file could be extracted from the PDF or replayed on the web \url{https://youtu.be/-Ga4DO3h_1c}.
\endinsert
...
repeat=0,
aactions=\renditionautoplay,
]{\picwidth=\hsize \inspic{./img/2022-08-26-16-09-04.213386-lightning.mp4.png}}
\caption/f   The embedded video file: {\em 2022-08-26-16-09-04.213386-lightning.mp4} shows lightning  negative leader with subsequent IC return stroke. Please click on the Figure to play the video, alternatively, the file could be extracted from the PDF.
\endinsert
