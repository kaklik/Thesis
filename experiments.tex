...
As the bonus THUNDERMILL01 provides additional angular information by outputting the value of each digitized voltage point on the electrodes during each half-rotation. This feature not only improves time resolution but also avoids averaging values over the entire rotation, which is a limitation of the Kleinwächter EFM 115 and similar electric field mills. Therefore, the THUNDERMILL01 offers a more precise and detailed measurement of the electric field changes. The angular sensitivity is explained in \mycite[c4].

Both mills were installed on a car and were not grounded. Therefore measures the gradient of electric potential between the sensor and the car body, capturing the vertical electric field component over a large area and influenced by the car's presence. As is visible from Figures \ref[figur_efmdata] and \ref[figur_THUNDERMILL01_data] the both EFMs captured the lightning effect on electric field above the car. The significant difference is visible in Figures \ref[figur_efmdatadetail] and \ref[figur_THUNDERMILL01_detail], where the THUNDERMILL01 is able to respond to electric field changes during different phases of a lightning. The main principle of fast time response is depicted in Figure \ref[figur_THUNDERMILL01_half-turn], where is shown the effect of lightning on the signal digitized from THUNDERMILL01 electrodes during a half-turn. 
